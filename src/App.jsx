  ...
  return (
    ...
    <div className={`min-h-screen bg-gray-100 font-inter text-base relative`}>
      ...
      <section id="publications" className={`py-20 md:py-32 bg-white/70 backdrop-blur-md text-gray-900`}>
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Preprints/Publications</h2>
          <div className="max-w-3xl mx-auto">
            <ul className="space-y-6">
              ...
              <li className="bg-gray-200 p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-700">
                  <a href="https://rdcu.be/eFiWu" target="_blank" rel="noopener noreferrer" className="text-cyan-600 hover:text-cyan-500">
                    Article link
                  </a>
                </p>
              </li>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gray-200 py-2 px-4 rounded-xl shadow-lg transition-transform hover:scale-105 duration-300 ease-in-out">
              ...
              (Teaching Assistant)
              Lectures on Étale Cohomology by Prof. G. Böckle
