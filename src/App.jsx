            ...
            <ul className="space-y-6">
              ...
              <li className="bg-gray-200 p-6 rounded-xl shadow-lg">
                ...
                <div className="flex flex-wrap gap-4 text-gray-700">
                  <a href="/webpage/public/D_elliptic/Notes_Talk_0-D_ell.pdf" target="_blank" rel="noopener noreferrer" download className="text-cyan-600 hover:text-cyan-500">
                    Overview Talk
                  </a>
                  <a href="/webpage/public/D_elliptic/Notes_Talk_3-D_ell.pdf" target="_blank" rel="noopener noreferrer" download className="text-cyan-600 hover:text-cyan-500">
                    Talk 3
                  </a>
                  <a href="\webpage/public/D_elliptic/Notes_Talk_9-D_ell.pdf" target="_blank" rel="noopener noreferrer" download className="text-cyan-600 hover:text-cyan-500">
                    Talk 9
                  </a>
                </div>
              </li>
              ...
              <li className="bg-gray-200 p-6 rounded-xl shadow-lg">
                ...
                <div className="flex flex-wrap gap-4 text-gray-700">
                  <a href="/webpage/public/KMI/Notes_Talk3_IKM.pdf" target="_blank" rel="noopener noreferrer" download className="text-cyan-600 hover:text-cyan-500">
                    Talk 3
                  </a>
              ...
              <li className="bg-gray-200 p-6 rounded-xl shadow-lg">
                ...
                <div className="flex flex-wrap gap-4 text-gray-700">
                  <a href="/webpage/public/RMC/Notes_Talk 3.pdf" target="_blank" rel="noopener noreferrer" download className="text-cyan-600 hover:text-cyan-500">
                    Talk 3
                  </a>
              ...
              <li className="bg-gray-200 p-6 rounded-xl shadow-lg">
                ...
                <div className="flex flex-wrap gap-4 text-gray-700">
                  <a href="/webpage/public/Rigid_GAGA.pdf" target="_blank" rel="noopener noreferrer" download className="text-cyan-600 hover:text-cyan-500">
                    Rigid GAGA
                  </a>
